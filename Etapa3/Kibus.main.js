var Kibus = function(canvas, mapWidth, mapHeight, heatmapCanvas){
	this.canvas = canvas;
	...
	heatmapCanvas.addEventListener('mousedown', mouse);
	heatmapCanvas.addEventListener('mousemove', mouse);
	...
	this.estado; //1 propaga, 2 retropropaga, 3 enfría, 4 avanza
	this.aux;
